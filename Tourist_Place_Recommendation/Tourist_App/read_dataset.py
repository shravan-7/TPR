...
import csv
from Tourist_App.models import Dataset
        ...
        with open("./review_dataset.csv", 'r', encoding='utf-8') as file:
            ...
            for row in reader:
                try:
                    ...
                    ID, Name, City, Category, Ratings, Rating_count, Description, Address, Map_link, Review_1, Review_2, Review_3, openingHours_0_day, openingHours_0_hours, openingHours_1_day, openingHours_1_hours, openingHours_2_day, openingHours_2_hours, openingHours_3_day, openingHours_3_hours, openingHours_4_day, openingHours_4_hours, openingHours_5_day, openingHours_5_hours, openingHours_6_day, openingHours_6_hours = row
